...
import static top.infra.common.RequestUtlis.findRequestWrapper;
 ...
 * {@link top.infra.common.CurlUtils}
...
public class ContentCachingRequestFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal( //
    ...
    if (interested) {
      final ContentCachingRequestWrapper found = findRequestWrapper(request, ContentCachingRequestWrapper.class);
      if (found == null) {
