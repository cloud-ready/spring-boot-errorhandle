...
/**
 * ExpectedError is thrown by user, not by libraries or frameworks.
 */
public class ExpectedError extends RuntimeException {
     ...
     */
    public ExpectedError(final String message) {
        super(message);
    }
     ...
     *                unknown.)
     */
    public ExpectedError(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     *              unknown.)
     */
    public ExpectedError(final Throwable cause) {
        super(cause);
    }
